...
- 핵심 기능 : 중복된 할인과 증정을 허용해서, 고객들이 혜택을 많이 받는다는 것을 체감할 수 있게 하는 것

<입력>
- [x] 12월 중 식당 예상 방문 날짜 입력받기 (숫자만 입력)
- [x] 주문할 메뉴와 개수 입력받기 (e.g. 시저샐러드-1,시저샐러드-1)

<출력>
- [x] 안녕하세요! 우테코 식당 12월 이벤트 플래너입니다.
- [x] 12월 xx일에 우테코 식당에서 받을 이벤트 혜택 미리 보기!
- [x] 주문 메뉴
- [x] 할인 전 총주문 금액
- [x] 증정 메뉴 
   - [x] 해당 없으면 '없음' 출력
...
- [x] 크리스마스 디데이 할인 (2023.12.1 ~ 2023.12.25)
   - [x] 1000원 시작. 날마다 100원씩 증가
   - [x] 총 금액에서 해당 금액만큼 할인
- [x] 크리스마스 디데이 할인 제외 (2023.12.1 ~ 2023.12.31) 동안 적용
   - [x] 평일 할인 (일요일~목요일): 디저트 메뉴 1개당 2,023원 할인
   - [x] 주말 할인 (금요일,토요일): 메인 메뉴 1개당 2023원 할인
   - [x] 특별할인 (달력에 별 있는 날): 총 주문 금액에서 1000원 할인
   - [x] 증정 이벤트(할인 전 총금액 12만원 이상): 샴페인 1개 증정
- [x] 혜택 금액에 따른 12월 이벤트 배지 부여 기능
   - [x] 5천원 이상: 별
   - [x] 1만원 이상: 트리
   - [x] 2만원 이상: 산타
